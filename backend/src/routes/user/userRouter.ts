...
import { changePassword, forgotPassword, getCurrentUser, login, logout, refreshToken, register, resendVerificationEmail, resetPassword, verifyEmail } from "../../controllers/auth/auth.controller.js";
...
Userrouter.post("/refresh-token", refreshToken);//refresh token given if user access token expire
...
Userrouter.post("/resend-verification",resendVerificationLimiter, resendVerificationEmail);//adding a rate limit rsend email 10min for 3 email
